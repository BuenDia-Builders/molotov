...
// Route-level loading skeleton (Suspense fallback) so the Artists grid does not pop
// in abruptly. Matches the my-work skeleton language: animate-pulse on bg-[var(--ember)].
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 lg:gap-8">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex flex-col bg-[var(--carbon)] overflow-hidden">
              <div className="aspect-[4/3] bg-[var(--ember)] animate-pulse" />
              <div className="px-5 py-4 flex flex-col gap-2">
                <div className="h-2 w-1/4 bg-[var(--ember)] animate-pulse" />
