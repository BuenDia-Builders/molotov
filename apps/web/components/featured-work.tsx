  ...
  return (
    <section className="bg-[var(--offwhite)]">
      <div className="mx-auto max-w-7xl px-6 py-36 md:px-10 md:py-52 lg:px-20">
        ...
        {/* Header — shifted right intentionally */}
        ...
        {/* Preview grid — dark cards on light section */}
        <div className="mt-20 grid grid-cols-1 gap-px overflow-hidden border border-black/10 bg-black/8 sm:grid-cols-2 lg:grid-cols-3">
          {[0, 1].map((i) => (
          ...
          <article className="bg-[var(--black)] p-4">
            ...
            <div className="mt-4 flex items-baseline justify-between gap-3">
              <div className="min-w-0">
                <p className="truncate font-[family-name:var(--font-display)] text-lg text-[var(--offwhite)] [font-variation-settings:'opsz'_24]">
