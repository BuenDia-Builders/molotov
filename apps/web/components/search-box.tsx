  ...
  return (
    <div ref={rootRef} className={`relative ${wide ? "w-full" : "w-full max-w-sm"}`}>
      <input
        ...
        className="h-9 w-full border border-black/15 bg-white/60 px-3 font-[family-name:var(--font-mono)] text-[11px] text-[var(--black)] placeholder:text-[var(--black)]/35 focus:border-[var(--blue)] focus:outline-none"
      />
      {open && results && (
