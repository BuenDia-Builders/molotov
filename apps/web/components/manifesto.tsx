    ...
    >
      <div className="grid gap-10 md:grid-cols-[auto_1fr] md:gap-20">
        <div className="md:pt-2">
          ...
          <p className="mt-1 font-[family-name:var(--font-mono)] text-[13px] text-[var(--offwhite)]/40">
            {t("manifesto.placeDate")}
          </p>
        </div>

        <div className="max-w-2xl space-y-7 font-[family-name:var(--font-display)] text-xl leading-[1.5] tracking-[-0.005em] text-[var(--offwhite)]/90 [font-variation-settings:'opsz'_40] md:text-2xl">
          <p>
