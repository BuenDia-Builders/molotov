  ...
  return (
    <section id="manifesto" className="bg-[var(--offwhite)] scroll-mt-24">
      <div className="mx-auto max-w-7xl px-6 py-20 md:px-10 md:py-28 lg:px-20">
        ...
        {/* Dark card — full width, like El Gato y La Caja. Editorial voice
            (Fraunces) here only — the manifesto is the one place the site
            reads like it was written, not shipped. */}
        <div className="bg-[var(--black)] px-8 py-14 md:px-16 md:py-20 lg:px-24 lg:py-28">
          <div className="mx-auto max-w-2xl space-y-10 font-[family-name:var(--font-editorial)] text-xl leading-[1.65] tracking-[-0.005em] text-[var(--offwhite)]/90 md:text-2xl">
            <p>
            ...
            <p>{t("manifesto.p3")}</p>
            <p>{t("manifesto.p4")}</p>
            <p className="font-[family-name:var(--font-mono)] text-[14px] text-[var(--offwhite)]/40">
